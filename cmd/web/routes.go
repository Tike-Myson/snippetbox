...
func (app *application) routes() http.Handler {
	...
	mux.Get("/user/recover-password", dynamicMiddleware.ThenFunc(app.recoverPasswordForm))
	mux.Post("/user/recover-password", dynamicMiddleware.ThenFunc(app.recoverPassword))
